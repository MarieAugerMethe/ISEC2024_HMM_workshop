...
Fit a simple two-state HMMs.

The answers are found in section below. But only peak if you are stuck.
...
# Code for polar bear data exercise
...
There is plenty of presistence in turning angle (very high peak at 0) and though hard to exactly pick out there are maybe two different peaks in step length, somthing around 0.2 and 1.7.
