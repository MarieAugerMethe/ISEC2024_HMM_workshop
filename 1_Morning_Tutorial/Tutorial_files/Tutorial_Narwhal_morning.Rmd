...
There is plenty of persistence in turning angle (very high peak at 0) and though hard to exactly pick out there are maybe two different peaks in step length, somthing around 0.2 and 1.7.
...
See Togunov et al. for a more complex HMM that fits the data better.